...
public class UnfollowersListFragment extends Fragment implements FollowersListContract.View {
    ...
    @BindView(R.id.unfollowers_recycler_view)
    RecyclerView recyclerView;

    public UnfollowersListFragment() {}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(presenter == null) {
            presenter = new UnfollowersListPresenter(this);
        }
        ...
        View view = inflater.inflate(R.layout.fragment_unfollowers_list, container, false);
